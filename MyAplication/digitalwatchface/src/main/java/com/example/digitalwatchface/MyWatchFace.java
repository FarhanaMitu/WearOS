...
public class MyWatchFace extends CanvasWatchFaceService {
    ...
    static int getComplicationId(
            MyWatchFaceActivity.ComplicationLocation complicationLocation) {
...
//            mTextPaint.setTextSize(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, getResources().getDisplayMetrics()));
            ...
            mDate = new SimpleDateFormat("EE, MMMM dd", Locale.getDefault());
        }
...
//            Log.d(TAG, "onComplicationDataUpdate() id: " + complicationId);
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            String text = mAmbient
                    ...
                    : String.format("%d:%02d:%02d %s", mCalendar.get(Calendar.HOUR),
                    mCalendar.get(Calendar.MINUTE), mCalendar.get(Calendar.SECOND), mCalendar.get(Calendar.HOUR)<12? "am" : "pm");
            canvas.drawText(text, mXOffset, mYOffset, mTextPaint);

            String dateText = mDate.format(now);
            canvas.drawText(dateText, mXOffset, mYOffset+30, mDatePaint);
        }
